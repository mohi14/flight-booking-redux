...
import { addBooking, removeBooking } from "./redux/bookings/actions";
...
function App() {
  ...
  const allBooking = useSelector((state) => state.bookings)
        ...
        <div className="mt-[160px] mx-4 md:mt-[160px] relative">
          <div className="bg-white rounded-md max-w-6xl w-full mx-auto">
            <form className="first-hero lws-inputform" onSubmit={handleSubmit}>
              ...
              <div className="des-from">
                <p>Journey Date</p>
                <input onChange={(e) => setJourneyDate(e.target.value)} type="date" className="outline-none px-2 py-2 w-full date" name="date" id="lws-date" required />
              </div>
              ...
              <div className="des-from !border-r-0">
                ...
                <div className="flex flex-row">
                  ...
                  <select onChange={(e) => setClassName(e.target.value)} className="outline-none px-2 py-2 w-full" name="ticketclassName" id="lws-ticketclassName" required>
                    <option value="" hidden>Please Select</option>
              ...
              <button className="addCity" type="submit" id="lws-addCity" onClick={() => setID(prev => prev + 1)} disabled={allBooking.length === 3}>
        ...
        <div className="table-container">
          <table className="booking-table">
            ...
            <tbody className="divide-y divide-gray-300/20" id="lws-previewBooked">
              ...
              {allBooking && allBooking.map((booking, idx) => <tr className="lws-bookedTable text-black" key={idx}>
                ...
                <td className="px-6 py-4 text-center">
                  <span className="lws-bookedclassName">{booking.className}</span>
                </td>
                <td className="px-6 py-4 text-center">
